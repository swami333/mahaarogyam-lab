        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center">
                <span className="mr-2">📧</span>
                <a href="mailto:info@mahaarogyam.com" className="hover:text-white">info@mahaarogyam.com</a>
              </li>
               <li className="flex items-center">
                <span className="mr-2">🌐</span>
                <a href="http://www.mahaarogyam.com" target="_blank" rel="noopener noreferrer" className="hover:text-white">www.mahaarogyam.com</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-12 border-t border-gray-700 pt-8 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} Maha Aarogyam Healthcare & Speciality Laboratory Pvt. Ltd. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
